...
if __name__=='__main__':
    #
    # Carries out grid search over all moment tensor parameters for the best fit double couple depth and magnitude of the 2020-04-04 SoCal event
    # Uses local database of Green's functions calculated via the FK method
    #
    # USAGE
    #   mpirun -n <NPROC> python GridSearch.FullMomentTensor_DCMagAndDepth_SOCAL.py
    #
