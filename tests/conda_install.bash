...
conda create -q --name env_step2 python=$PYTHON_VERSION --file env.yaml > tests/log2
...
conda create -q --name env_step3 python=$PYTHON_VERSION --file env.yaml > tests/log3
