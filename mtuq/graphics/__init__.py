...
from mtuq.graphics.uq.lune import plot_misfit_lune, plot_likelihood_lune, plot_marginal_lune
...
from mtuq.graphics.uq.depth import plot_misfit_depth, plot_likelihood_depth, plot_marginal_depth
from mtuq.graphics.uq.hypocenter import plot_misfit_xy, plot_mt_xy
