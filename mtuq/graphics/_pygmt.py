...
def plot_force(filename, force_dict):
    ...
    # specify basemap
    fig.basemap(projection=proj_arg, region=area_arg, frame=['xg180','yg60'])

    # plot arcs
    fig.text(x=90., y=0., text='E', font='40p')
    fig.plot(x=[90.,90.], y=[90.,7.5], pen='1.5p,0/0/0/35')
    fig.plot(x=[90.,90.], y=[-90.,-7.5], pen='1.5p,0/0/0/35')
    #fig.text(x=0., y=0., text='S', font='40p')
    fig.plot(x=[0.,0.], y=[90.,7.5], pen='1.5p,0/0/0/35')
    fig.plot(x=[0.,0.], y=[-90.,-7.5], pen='1.5p,0/0/0/35')
    fig.text(x=-90., y=0., text='W', font='40p')
    fig.plot(x=[-90.,-90.], y=[90.,7.5], pen='1.5p,0/0/0/35')
    fig.plot(x=[-90.,-90.], y=[-90.,-7.5], pen='1.5p,0/0/0/35')

    # plot force orientation
    fig.plot(x=lon, y=lat, style="d40p", pen="1p,black", fill="black")
