...
if __name__=='__main__':
    """ Carries out grid search over double-couple parameters, magnitude, and
       event depth; event location is fixed
    """
    ...
    origins = DepthGrid(origin, depth=np.linspace(5.,20.,1.))

    # read Green's functions
    factory = greens.fk.factory(paths.greens_functions)
    greens = factory(stations, origins)
    ...
    grid_search_mpi(processed_data, processed_greens, misfit, grid, origins)
