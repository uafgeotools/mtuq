...
The response of a medium to an impulsive source is called a Green's function.  This page describes the role of Green's functions in source inversions and the types of Green's functions supported by MTUQ, as well as how they can be obtained.
