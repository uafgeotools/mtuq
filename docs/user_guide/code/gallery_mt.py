...
if __name__=='__main__':
    #
    # Reproduces figures shown in mtuq/docs/user_guide/gallery_mt.rst
    #
    # USAGE
    #   mpirun -n <NPROC> python gallery_mt.py
    #   
    ...
    grid = FullMomentTensorGridSemiregular(
        npts_per_axis=10,
        magnitudes=np.linspace(4.3, 4.7, 10))
    ...
    if comm.rank==0:
        ...
        plot_misfit_lune(event_id+'_misfit_lune.png', 
        ...
        plot_likelihood_lune(event_id+'_likelihood_lune.png', 
            results, sigma**2, title='Maximum likelihoods')

        plot_marginal_vw(event_id+'_marginal_vw.png', 
            results, sigma**2, title='Marginal likelihoods')
