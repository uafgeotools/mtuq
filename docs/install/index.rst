...
If PyGMT is not present, MTUQ may fall back to GMT or ObsPy in some cases.  We note that some versions of GMT and ObsPy do not plot full moment tensors correctly (see this `issue <https://github.com/obspy/obspy/issues/2388>`_).
